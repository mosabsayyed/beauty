...
const RiskDesk: React.FC = () => {
    ...
    const riskData = React.useMemo(() => {
        ...
        return {
            'outcome1': { ...d.outcome1, title: language === 'ar' ? 'ŸÖÿÆÿßÿ∑ÿ± ÿßŸÑÿßŸÇÿ™ÿµÿßÿØ ÿßŸÑŸÉŸÑŸä' : 'Macro Risks' },
            'outcome2': { ...d.outcome2, title: language === 'ar' ? 'ŸÖÿÆÿßÿ∑ÿ± ÿßŸÑÿ™ÿ¥ÿ∫ŸäŸÑ' : 'Operational Risks' },
            'outcome3': { ...d.outcome3, title: language === 'ar' ? 'ŸÖÿÆÿßÿ∑ÿ± ÿßŸÑÿ™ŸÇŸÜŸäÿ©' : 'Tech Risks' },
            'outcome4': { ...d.outcome4, title: language === 'ar' ? 'ŸÖÿÆÿßÿ∑ÿ± ÿßŸÑŸÖŸàÿßÿ±ÿØ ÿßŸÑÿ®ÿ¥ÿ±Ÿäÿ©' : 'People Risks' }
        } as any;
    }, [data, language]);
                ...
                <div className="col-span-8 bg-[#111827] border border-slate-700 rounded-lg p-5 flex flex-col h-full relative overflow-hidden">
                    <div className="flex justify-between items-center mb-4 shrink-0 z-10">
                        <h3 className="text-lg font-semibold text-white flex items-center gap-2">
                             <span className="text-[#D4AF37]">‚ñ†</span> {language === 'ar' ? 'ŸÖÿµŸÅŸàŸÅÿ© ÿßŸÑŸÖÿÆÿßÿ∑ÿ±' : 'Risk & Outcomes Matrix'}
                        </h3>
                    </div>
...
·‚ ‚Î
ÎÛ Ûı
ı˚ ˚ööõ *cascade08õ§
§• •ß
ß® ®≠
≠Æ Æø
ø¡ ¡∆
∆®l "(c913c588291934840a75d01805714920db35716a2Xfile:///home/mosab/projects/chatmodule/frontend/src/pages/josoor-dashboards/RiskDesk.tsx:&file:///home/mosab/projects/chatmodule